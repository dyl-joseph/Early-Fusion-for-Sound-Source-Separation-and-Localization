...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_audio', default='/home/dylan_j/Documents/sound_diar/data/audio',
                        help="root for extracted audio files")
    parser.add_argument('--root_frame', default='/home/dylan_j/Documents/sound_diar/data/frames',
                        help="root for extracted video frames")
    parser.add_argument('--fps', default=8, type=int,
                        help="fps of video frames")
    parser.add_argument('--path_output', default='/home/dylan_j/Documents/sound_diar/data',
    ...
    n_val = n_train + int(len(infos)*0.1)
    random.shuffle(infos)

    trainset = infos[0:n_train]
    valset = infos[n_train:n_val]
    testset = infos[n_val:]
