...
class ArgParser(object):
    def __init__(self):
        ...
        parser.add_argument('--arch_sound', default='unet5',
                            help="architecture of net_sound")
        parser.add_argument('--arch_frame', default='3dresnet',
        ...
        parser.add_argument('--num_frames', default=160, type=int,
    ...
    def add_train_arguments(self):
        ...
        parser.add_argument('--mo1', default='train',
                            help="train/eval")
        parser.add_argument('--list_train',
                            default='/home/dylan_j/Documents/sound_diar/data/train.csv')
        parser.add_argument('--list_val',
                            default='/home/dylan_j/Documents/sound_diar/data/val.csv')
